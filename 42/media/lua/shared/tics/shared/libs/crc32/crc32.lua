...
local crc32lua = require 'tics/shared/libs/crc32/crc32lua'
local bit = require 'tics/shared/libs/bit32/numberlua'
local band = bit.band
local bor = bit.bor
...
local crc32_byte = crc32lua.crc32_byte

local crc_mt = {
    update = function(self, data)
        self[1] = crc32_byte(data, self[1])
        return self
    end,
    reset = function(self)
        self[1] = 0
