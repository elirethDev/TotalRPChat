...
local TrpcDispatch = {
    color    = { fn = ProcessColorCommand,    hint = 'color command expects the format: "/color value" with value as 255, 255, 255 or #FFFFFF' },
    pitch    = { fn = ProcessPitchCommand,    hint = 'pitch command expects the format: "/pitch value" with value from 0.85 to 1.45' },
    roll     = { fn = ProcessRollCommand,     hint = 'roll command expects the format: "/roll xdy" with x and y numbers and x from 1 to 20' },
    language = { fn = ProcessLanguageCommand, hint = 'language command expects the format: "/language en" with "en" the language code' },
}
