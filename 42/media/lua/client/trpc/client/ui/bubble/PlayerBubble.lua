...
function PlayerBubble:drawBubbleFrame(leftX, leftW, centerW, centerX, rightX, rightW, topH, centerY, botH, centerH, botY)
...
function PlayerBubble:drawBubbleArrow(x, y, width, height)
